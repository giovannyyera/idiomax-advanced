...
export class ApiService {
  ...
  cadastrarUsuario(dados: {
    nome: string;
    codigo_idioma_aprendizado: number;
  }) {
  ...
  listarExerciciosUsuario(codigo: number) {
    return this.http.get(
      `${this.apiUrl}/usuarios/${codigo}/exercicios`
    );
  }
  ...
  responderExercicio(
    ...
    return this.http.post(
      `${this.apiUrl}/usuarios/${codigoUsuario}/responder`,
      dados
    );
  }
  ...
  finalizarRodada(codigoUsuario: number) {
    return this.http.post(
      `${this.apiUrl}/usuarios/${codigoUsuario}/finalizar-rodada`,
      {}
    );
  }
  ...
  buscarCertificado(codigo: number) {
    return this.http.get(
      `${this.apiUrl}/usuarios/${codigo}/certificado`
    );
  }
